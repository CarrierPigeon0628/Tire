<template>
    ...
    <div style="padding: 10px;">
        <div style="font-size:13px;color: gray;margin: 10px 0;">轮胎评价</div>
        <nut-textarea rows="5" v-model=text limit-show max-length="50" placeholder="此轮胎的体验如何呢？请写下你宝贵的建议吧！" />
        <div style="font-size:13px;color: gray;margin: 10px 0;">轮胎评分</div>
